                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    {(conversionData || (editingDirection === "payment" && paymentAmountOverride)) && needsConversion && (() => {
                      const rawValue = editingDirection === "payment"
                        ? paymentAmountOverride
                        : conversionData?.convertedAmount;
                      const decimals = getCurrencyDecimals(paymentCurrency);
                        ...
                        <div className="bg-green-50 dark:bg-green-950 p-3 rounded-md border border-green-200 dark:border-green-800">
                          ...
                          <div className="flex items-baseline gap-2 mt-1">
                            <Input
                              ...
                              inputMode="decimal"
                              placeholder="0"
                              className="bg-transparent border-0 shadow-none text-lg font-bold text-green-800 dark:text-green-200 px-0 focus-visible:ring-0 h-auto py-0 flex-1"
                            ...
                            />
                            <span className="text-lg font-bold text-green-800 dark:text-green-200">{paymentCurrency}</span>
                          </div>
                        </div>
                      );
                    })()}
