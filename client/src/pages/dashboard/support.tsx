          ...
          <Card className="hover-elevate min-w-0">
            <CardHeader className="pb-2 px-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <CardTitle className="text-xs">Chaîne WhatsApp</CardTitle>
              </div>
              <CardDescription className="text-xs">Rejoignez notre chaîne</CardDescription>
            </CardHeader>
            <CardContent className="text-xs space-y-2 px-3 pb-3">
              <p className="text-muted-foreground">Restez informé</p>
              {isLoading ? (
                <div className="flex items-center justify-center h-8">
                  <Loader2 className="w-4 h-4 animate-spin" />
                </div>
                ...
                >
                  <SiWhatsapp className="w-3 h-3 mr-1 flex-shrink-0" />
                  <span className="truncate">Rejoindre la chaîne</span>
                </Button>
              )}
            </CardContent>
          </Card>
