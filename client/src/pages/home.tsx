  ...
  return (
    <div ref={scrollRef} className="w-full min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative py-12 md:py-24 lg:py-36 overflow-hidden bg-black">
          ...
          <img src={heroMainImage} alt="" className="w-full h-full object-cover brightness-110 contrast-105" decoding="async" />
        ...
        <div className="container mx-auto px-2 sm:px-4 md:px-8 max-w-7xl relative z-10">
          <div className="space-y-3 sm:space-y-6 lg:space-y-8 max-w-2xl">
            <div className="space-y-2 sm:space-y-4 -translate-y-2 sm:-translate-y-4 lg:-translate-y-6">
              <h1 className="text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg font-bold text-white leading-tight max-w-xl">
                Paiements Mobile Money pour l'Afrique
              </h1>
              <p className="text-xs sm:text-xs md:text-sm lg:text-base text-white/80 max-w-xl">
                Acceptez les paiements Orange Money, MTN, Moov, Wave et plus dans plus de 17 pays. Plateforme simple, sécurisée et fiable.
              </p>
            </div>
            <div className="flex flex-wrap gap-2 sm:gap-4 -translate-y-2 sm:-translate-y-4 lg:-translate-y-6">
              <Link href="/signup">
