            ...
            {orangeInstruction && (
              <Alert className="bg-orange-50 dark:bg-orange-950 border-orange-200 dark:border-orange-800">
                ...
                <AlertDescription className="text-sm text-orange-800 dark:text-orange-200">
                  ...
                  {currentCountry === "BF" && (paidAmount || form.getValues("amount")) ? (
                    <div className="mt-2 flex items-center gap-2">
                      <div className="flex-1 bg-white dark:bg-gray-900 border border-orange-300 dark:border-orange-700 rounded-md px-3 py-2">
                        <code className="text-base font-bold text-orange-700 dark:text-orange-400">
                          *144*4*6*{paidAmount || form.getValues("amount")}#
                        </code>
                      </div>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                        onClick={() => copyUssdCode(`*144*4*6*${paidAmount || form.getValues("amount")}#`)}
